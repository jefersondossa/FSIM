...
Point(1) = {0, 0, 0, 1.0};
//+
Point(2) = {-dist, dist, 0, 1.0};
//+
Point(3) = {dist, dist, 0, 1.0};
//+
Point(4) = {dist, -dist, 0, 1.0};
//+
Point(5) = {-dist, -dist, 0, 1.0};
//+
Point(6) = {0, dist, 0, 1.0};
//+
Point(7) = {0, -dist, 0, 1.0};
//+
Point(8) = {-dist, 0, 0, 1.0};
//+
Point(9) = {dist, 0.00001, 0, 1.0};
Point(10) = {dist, -0.00001, 0, 1.0};
//+
Line(1) = {3, 9};
//+
Line(2) = {10, 4};
