...
#ifndef INTEG_QUADRATURE3_2_H
#define INTEG_QUADRATURE3_2_H
...
public:
    ...
    typedef ublas::bounded_matrix<double, 8*DIM-13,DIM>  PointCoord;

    //Defines the type "PointWeight" which stores the
    //integration points weights
    typedef ublas::bounded_vector<double, 8*DIM-13>      PointWeight;

    //Integration point logical vector
    typedef ublas::bounded_vector<bool, 8*DIM-13>        PointLogical;
