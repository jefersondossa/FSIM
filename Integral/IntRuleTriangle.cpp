...
void IntRuleTriangle::SetOrder(int order) {
    ...
    case 2:
        fPoints.resize(3,2);
        fWeights.resize(3);
        fPoints(0,0) = 0.166666666666666666666666666666667e+0;
        fPoints(0,1) = 0.666666666666666666666666666666667e+0;
        fPoints(1,0) = 0.666666666666666666666666666666667e+0;
        fPoints(1,1) = 0.166666666666666666666666666666667e+0;
        fPoints(2,0) = 0.166666666666666666666666666666667e+0;
        fPoints(2,1) = 0.166666666666666666666666666666667e+0;
        fWeights[0] = 1./6.;
        fWeights[1] = 1./6.;
        fWeights[2] = 1./6.;
        break;
