...
public:
    ...
    typedef ublas::bounded_matrix<double, 7*DIM-10,DIM>  PointCoord;

    //Defines the type "PointWeight" which stores the
    //integration points weights
    typedef ublas::bounded_vector<double, 7*DIM-10>      PointWeight;

    //Integration point logical vector
    typedef ublas::bounded_vector<bool, 7*DIM-10>        PointLogical;
