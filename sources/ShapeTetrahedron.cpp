...
const int ShapeTetrahedron::Dimension;
void ShapeTetrahedron::Shape(VecDouble &xi, VecDouble &phi) const {
...
void ShapeTetrahedron::ShapeGradient(VecDouble &xi, MatrixDouble &dphi) const {
...
void ShapeTetrahedron::ShapeHessian(VecDouble &xi, std::vector<MatrixDouble > &ddphi) const {
    const double xsi1 = xi[0];
        const double xsi2 = xi[1];
        const double xsi3 = xi[2];
        switch (fOrder)
...
void ShapeTetrahedron::getCoordinates(MatrixDouble &coord) const {
