...
//------------------------------------------------------------------------------
void ShapeFunction::evaluate(VecDouble &xi, VecDouble &phi) const {
    if (fDimension == 2){
        double xsi1 = xi[0];
        double xsi2 = xi[1];
...
//------------------------------------------------------------------------------
void ShapeFunction::evaluateGradient(VecDouble &xi, MatrixDouble &dphi) const {
...
//------------------------------------------------------------------------------
void ShapeFunction::evaluateHessian(VecDouble &xi, std::vector<MatrixDouble > &ddphi) const {
...
void ShapeFunction::getCoordinates(MatrixDouble &coord) const {
