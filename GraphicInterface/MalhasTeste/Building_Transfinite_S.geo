...
//+
Transfinite Curve {4, 20, 3, 19, 18, 18, 17, 21, 1, 32, 22, 23, 2, 5, 7, 6, 14, 8, 9, 13, 15, 16, 10, 12, 11} = 60 Using Progression 1;
//+
Transfinite Curve {26, 31, 28, 27, 30, 25, 24, 29} = 30 Using Progression 2;
//+
