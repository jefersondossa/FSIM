#ifndef TrescaPerfectPlastic_H
#define TrescaPerfectPlastic_H

#include "PlasticityModel.h"
#include "PlasticStep.h"

/// @brief Implements the linear hardening plasticity model
class TrescaPerfectPlastic : public PlasticityModel
{
private:
    enum ETrescaPerfectPlasticDirection{EMainPlane, ERightCorner, ELeftCorner};
    //The principal stresses
    double fS1, fS2, fS3;
    std::vector<MatrixDouble> fEigenprojections;
    ETrescaPerfectPlasticDirection fReturnDirection;
...
public:
    ...
    TrescaPerfectPlastic(WeakForm *elast);
