#include "TrescaPerfectPlastic.h"
#include "ElasticTruss.h"
#include "Elasticity2D.h"
#include "PositionalTruss.h"
#include "ElasticityPositional2D.h"

TrescaPerfectPlastic::TrescaPerfectPlastic(WeakForm *elast) : PlasticityModel(elast){
...
REAL TrescaPerfectPlastic::YieldFunction(int &index, IntPointData &data, Tensor3D &Stress){
    REAL YF = 0.;
...
REAL TrescaPerfectPlastic::PlasticMultiplier(int &index, IntPointData &data, Tensor3D &Stress){
