...
void ShapeTetrahedronCub::Shape(VecDouble &xi, VecDouble &phi, MatrixDouble &dphi, VecInt orders) {
    ...
    phi[9 ] = (9.0 / 2.0) * (3.0 * xsi1 - 1.0) * xsi1 * xsi2;
    phi[8 ] = (9.0 / 2.0) * (3.0 * xsi2 - 1.0) * xsi1 * xsi2;
    phi[10] = (9.0 / 2.0) * (3.0 * xsi2 - 1.0) * xsi2 * xsi4;
    phi[11] = (9.0 / 2.0) * (3.0 * xsi4 - 1.0) * xsi2 * xsi4;
    phi[6 ] = (9.0 / 2.0) * (3.0 * xsi3 - 1.0) * xsi3 * xsi4;
    phi[7 ] = (9.0 / 2.0) * (3.0 * xsi4 - 1.0) * xsi3 * xsi4;
    phi[14] = (9.0 / 2.0) * (3.0 * xsi3 - 1.0) * xsi2 * xsi3;
    phi[15] = (9.0 / 2.0) * (3.0 * xsi2 - 1.0) * xsi2 * xsi3;
    phi[12] = (9.0 / 2.0) * (3.0 * xsi3 - 1.0) * xsi1 * xsi3;
    phi[13] = (9.0 / 2.0) * (3.0 * xsi1 - 1.0) * xsi1 * xsi3;
    phi[19] = 27.0 * xsi1 * xsi2 * xsi4;
    phi[16] = 27.0 * xsi1 * xsi3 * xsi4;
    phi[18] = 27.0 * xsi2 * xsi3 * xsi4;
    phi[17] = 27.0 * xsi1 * xsi2 * xsi3;
    ...
    dphi(0,9 ) = 9.0 / 2.0 * (-1.0 + 6.0 * xsi1) * xsi2;
    dphi(0,8 ) = 9.0 / 2.0 * xsi2 * (-1.0 + 3.0 * xsi2);
    dphi(0,10) = -9.0 / 2.0 * xsi2 * (-1.0 + 3.0 * xsi2);
    dphi(0,11) = 9.0 / 2.0 * xsi2 * (-5.0 + 6.0 * xsi1 + 6.0 * xsi2 + 6.0 * xsi3);
    dphi(0,6 ) = -9.0 / 2.0 * xsi3 * (-1.0 + 3.0 * xsi3);
    dphi(0,7 ) = 9.0 / 2.0 * xsi3 * (-5.0 + 6.0 * xsi1 + 6.0 * xsi2 + 6.0 * xsi3);
    dphi(0,14) = 0.0;
    dphi(0,15) = 0.0;
    dphi(0,12) = 9.0 / 2.0 * xsi3 * (-1.0 + 3.0 * xsi3);
    dphi(0,13) = 9.0 / 2.0 * (-1.0 + 6.0 * xsi1) * xsi3;
    dphi(0,19) = -27.0 * xsi2 * (-1.0 + 2.0 * xsi1 + xsi2 + xsi3);
    dphi(0,16) = -27.0 * xsi3 * (-1.0 + 2.0 * xsi1 + xsi2 + xsi3);
    dphi(0,18) = -27.0 * xsi2 * xsi3;
    dphi(0,17) = 27.0 * xsi2 * xsi3;
    ...
    dphi(1,9 ) = 9.0 / 2.0 * xsi1 * (-1.0 + 3.0 * xsi1);
    dphi(1,8 ) = 9.0 / 2.0 * xsi1 * (-1.0 + 6.0 * xsi2);
    dphi(1,10) = -9.0 / 2.0 * (1.0 - xsi1 - 8.0 * xsi2 - xsi3 + 6.0 * xsi1 * xsi2 + 6.0 * xsi2 * xsi3 + 9.0 * xsi2 * xsi2);
    dphi(1,11) = 9.0 / 2.0 * (2.0 - 5.0 * xsi1 + 3.0 * xsi1 * xsi1 - 10.0 * xsi2 + 12.0 * xsi1 * xsi2 + 9.0 * xsi2 * xsi2 - 5.0 * xsi3 + 6.0 * xsi1 * xsi3 + 12.0 * xsi2 * xsi3 + 3.0 * xsi3 * xsi3);
    dphi(1,6 ) = -9.0 / 2.0 * xsi3 * (-1.0 + 3.0 * xsi3);
    dphi(1,7 ) = 9.0 / 2.0 * xsi3 * (-5.0 + 6.0 * xsi1 + 6.0 * xsi2 + 6.0 * xsi3);
    dphi(1,14) = 9.0 / 2.0 * (-1.0 + 3.0 * xsi3) * xsi3;
    dphi(1,15) = 9.0 / 2.0 * (-1.0 + 6.0 * xsi2) * xsi3;
    dphi(1,12) = 0.0;
    dphi(1,13) = 0.0;
    dphi(1,19) = -27.0 * xsi1 * (-1.0 + xsi1 + 2.0 * xsi2 + xsi3);
    dphi(1,16) = -27.0 * xsi1 * xsi3;
    ...
    dphi(2,9 ) = 0.0;
    dphi(2,8 ) = 0.0;
    dphi(2,10) = -9.0 / 2.0 * xsi2 * (-1.0 + 3.0 * xsi2);
    dphi(2,11) = 9.0 / 2.0 * xsi2 * (-5.0 + 6.0 * xsi1 + 6.0 * xsi2 + 6.0 * xsi3);
    dphi(2,6 ) = -9.0 / 2.0 * (1.0 - xsi1 - xsi2 - 8.0 * xsi3 + 6.0 * xsi1 * xsi3 + 6.0 * xsi2 * xsi3 + 9.0 * xsi3 * xsi3);
    dphi(2,7 ) = 9.0 / 2.0 * (2.0 - 5.0 * xsi1 + 3.0 * xsi1 * xsi1 - 5.0 * xsi2 + 6.0 * xsi1 * xsi2 + 3.0 * xsi2 * xsi2 - 10.0 * xsi3 + 12.0 * xsi1 * xsi3 + 12.0 * xsi2 * xsi3 + 9.0 * xsi3 * xsi3);
    dphi(2,14) = 9.0 / 2.0 * xsi2 * (-1.0 + 6.0 * xsi3);
    dphi(2,15) = 9.0 / 2.0 * xsi2 * (-1.0 + 3.0 * xsi2);
    dphi(2,12) = 9.0 / 2.0 * xsi1 * (-1.0 + 6.0 * xsi3);
    dphi(2,13) = 9.0 / 2.0 * xsi1 * (-1.0 + 3.0 * xsi1);
    dphi(2,19) = -27.0 * xsi1 * xsi2;
    dphi(2,16) = -27.0 * xsi1 * (-1.0 + xsi1 + 2.0 * xsi3 + xsi2);
    dphi(2,18) = -27.0 * xsi2 * (-1.0 + xsi1 + 2.0 * xsi3 + xsi2);
    dphi(2,17) = 27.0 * xsi1 * xsi2;
