...
public:
    ...
    typedef ublas::bounded_matrix<double, 12,DIM>  PointCoord;

    //Defines the type "PointWeight" which stores the
    //integration points weights
    typedef ublas::bounded_vector<double, 12>      PointWeight;

    //Integration point logical vector
    typedef ublas::bounded_vector<bool, 12>        PointLogical;

    /// integration points int variable
    typedef ublas::bounded_vector<int, 12>         PointIntVar;
    ...
    typedef ublas::bounded_vector<double, 12>      NodalValuesQuad;
...
double IntegQuadratureSpecial<2>::PointList(int i, int j){
    ...
    pointCoord(0,0) = 0.873821971016996;
    pointCoord(0,1) = 0.063089014491502;

    pointCoord(1,0) = 0.063089014491502;
    pointCoord(1,1) = 0.873821971016996;
      
    pointCoord(2,0) = 0.063089014491502;
    pointCoord(2,1) = 0.063089014491502;
      
    pointCoord(3,0) = 0.501426509658179;
    pointCoord(3,1) = 0.249286745170910;
      
    pointCoord(4,0) = 0.249286745170910;
    pointCoord(4,1) = 0.501426509658179;
      
    pointCoord(5,0) = 0.249286745170910;
    pointCoord(5,1) = 0.249286745170910;
      
    pointCoord(6,0) = 0.636502499121399;
    pointCoord(6,1) = 0.310352451033785;

    pointCoord(7,0) = 0.636502499121399;
    pointCoord(7,1) = 0.053145049844816;

    pointCoord(8,0) = 0.310352451033785;
    pointCoord(8,1) = 0.636502499121399;

    pointCoord(9,0) = 0.310352451033785;
    pointCoord(9,1) = 0.053145049844816;

    pointCoord(10,0) = 0.053145049844816;
    pointCoord(10,1) = 0.636502499121399;

    pointCoord(11,0) = 0.053145049844816;
    pointCoord(11,1) = 0.310352451033785;
...
double IntegQuadratureSpecial<2>::WeightList(int i){
    ...
    pointWeight(0) = 0.050844906370207;
    pointWeight(1) = 0.050844906370207;
    pointWeight(2) = 0.050844906370207;
    pointWeight(3) = 0.116786275726379;
    pointWeight(4) = 0.116786275726379;
    pointWeight(5) = 0.116786275726379;
    pointWeight(6) = 0.082851075618374;
    pointWeight(7) = 0.082851075618374;
    pointWeight(8) = 0.082851075618374;
    pointWeight(9) = 0.082851075618374;
    pointWeight(10) = 0.082851075618374;
    pointWeight(11) = 0.082851075618374; 
...
//------------------------------------------------------------------------------
template<>
double IntegQuadratureSpecial<2>::interpolateQuadraticVariable(NodalValuesQuad nValues,
                                                        int point){
...
template<>
double IntegQuadratureSpecial<3>::interpolateQuadraticVariable(NodalValuesQuad nValues,
                                                        int point){
