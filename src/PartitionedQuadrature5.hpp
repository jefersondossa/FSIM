...
public:
    ...
    typedef ublas::bounded_matrix<double, 14,DIM>  PointCoord;

    //Defines the type "PointWeight" which stores the
    //integration points weights
    typedef ublas::bounded_vector<double, 14>      PointWeight;

    //Integration point logical vector
    typedef ublas::bounded_vector<bool, 14>        PointLogical;

    /// integration points int variable
    typedef ublas::bounded_vector<int, 14>         PointIntVar;
...
pointWeight(0) = 	0.0562500000000000 	;
pointWeight(1) = 	0.0314847951362068 	;
pointWeight(2) = 	0.0314847951362068 	;
pointWeight(3) = 	0.0314847951362068 	;
pointWeight(4) = 	0.0330985381971264 	;
pointWeight(5) = 	0.0330985381971264 	;
pointWeight(6) = 	0.0330985381971264 	;
pointWeight(7) = 	0.0562500000000000 	;
pointWeight(8) = 	0.0314847951362068 	;
pointWeight(9) = 	0.0314847951362068 	;
pointWeight(10) = 	0.0314847951362068 	;
pointWeight(11) = 	0.0330985381971264 	;
pointWeight(12) = 	0.0330985381971264 	;
pointWeight(13) = 	0.0330985381971264 	;
