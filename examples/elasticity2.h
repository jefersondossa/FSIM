...

{
    ...
    Elasticity2D * matelasticity1 = new Elasticity2D(1, 1, 0.0); 
    Elasticity2D * matelasticity2 = new Elasticity2D(2, 1, 0.0); 
    //matpoisson->SetForcingFunction(forcingFunctionPoisson);
    cmesh->InsertMaterial(matelasticity1);
    cmesh->InsertMaterial(matelasticity2);
    ...
    VecDouble val2(2);
    val2[1] = 1.0;
    L2Projection * matbc1 = new L2Projection(3,0,BoundaryConditionType::kDirectionalHomogeneousDirichlet,val1,val2);
    val2.setZero();
    val2[0] = -2.0;
    L2Projection * matbc2 = new L2Projection(4,0,BoundaryConditionType::kDirectionalNonHomogeneousDirichlet,val1,val2);
    val2.setZero();
    L2Projection * matbc3 = new L2Projection(5,dimension-1,BoundaryConditionType::kNeumann,val1,val2);
    ...
    GmshTools::Read(*cmesh,"../revisaoLocal.msh");
