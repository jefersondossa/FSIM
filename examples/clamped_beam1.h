   ...
   //Verify yhe main.cpp
   //Verify path in .vscode\launch.json
...
auto yieldFunction = [](const double &plast, double &sigma_y, double &hardening){
    ...
    Elasticity2D * matelas = new Elasticity2D(13,1.e3,.3,false);
    ...
    VecDouble val2(2);
    val2.setZero();
    L2Projection * matbc1 = new L2Projection(14,2,0,val1,val2);
    ...
    val2[1] = -0.06;
    val2[0] = 0.02;
    L2Projection * matbc2 = new L2Projection(11,2,0,val1,val2);
    ...
    IncrementalAnalysis an(cmesh,SolverType::ELU, 1, bcIncrement,1.e-7,30);
