    ...
    const int dimension = 2;
{
    ...
    Elasticity2D * matelas = new Elasticity2D(11,2.067e8,.3);
    //BC
    ...
    val2[1] = -2.067e6;
    L2Projection * matbc1 = new L2Projection(6,1,1,val1,val2);
    L2Projection * matbc2 = new L2Projection(7,1,1,val1,val3);
    L2Projection * matbc5 = new L2Projection(10,1,0,val1,val3);
    val3[0] = 1.;
    L2Projection * matbc3 = new L2Projection(8,1,3,val1,val3);
    L2Projection * matbc4 = new L2Projection(9,1,3,val1,val3);
    ...
    VonMises *plastmodel = new VonMises(matelas,6.89e4,1.e6); 
    cmesh->InsertMaterial(matelas);
    // cmesh->InsertMaterial(plastmodel);
    std::vector<L2Projection *> bcIncrement = {matbc1};
  
    GmshTools::Read(*cmesh,"../mohrcoulomb.msh");

    IncrementalAnalysis an(cmesh,SolverType::EUmfpack, 20, bcIncrement,1.e-4);
